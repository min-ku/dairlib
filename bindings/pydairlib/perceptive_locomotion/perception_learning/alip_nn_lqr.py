...
class AlipFootstepNNLQR(AlipFootstepLQR):
    ...
    def __init__(self, alip_params: AlipFootstepLQROptions,
        ...
        #self.output_port_indices['hmap'] = self.DeclareVectorOutputPort(
        #        "hmap", 3*64*64, self.calculate_hmap
        #    ).get_index()
        #self.output_port_indices['cost_grid'] = self.DeclareVectorOutputPort(
        #        "cost_grid", 64*64, self.calculate_grid_cost
        #    ).get_index()
    ...
    #def calculate_hmap(self, context: Context, heightmap: BasicVector):
    ...
    #    )
    #    height_map.set_value(hmap.flatten())
